    ...
    <div class="login-wrapper">
        ...
        <div class="form-wrapper">
            <form action="AuthServlet?action=login" method="post" onsubmit="return check()">
                <input type="hidden" name="forwardPage" id="forwardPage" value="user_list.jsp"/>
                ...
                <input type="text" name="validationCode" id="validationCode" placeholder="code" class="input-item"
