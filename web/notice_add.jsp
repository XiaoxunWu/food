...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea type="text" name="noticeText" class="layui-input" style="height: 100px;padding-left: 10px;" placeholder="text ....."></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">NoticeTime：</label>
        <div class="layui-input-block">
            <input type="text" name="noticeDate" lay-verify="required" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
