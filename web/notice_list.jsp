...
<script type="text/html" id="myToolbar">
    <div class="layui-btn-container">
        <c:if test="${loginUser.userType == 'user'}"><button class='layui-btn layui-btn-sm' lay-event='add'>add</button></c:if>
    </div>
</script>
<script>
    ...
    layui.use('table', function () {
            ...
            cols: [
                [
                        ...
                        },
                    {
                        ...
                        width: 130,
                        templet: vo => {
                            let flag = ${loginUser.userType == loginUser.userType};
        ...
        table.on('tool(myTable)', function (obj) { //注：tool 是工具条事件名，myTable 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'del') { //删除
                ...
                // layer.close(index);
                //parent.location.reload();//刷新父级页面
                layer.msg(data.noticeName + ' del success！');
                // });
