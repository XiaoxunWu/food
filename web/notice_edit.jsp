...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea type="text" name="noticeText" class="layui-input" style="height: 100px;padding-left: 10px;" placeholder="text......">${vo.noticeText}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">NoticeTime：</label>
        <div class="layui-input-block">
            <input type="text" name="noticeDate" lay-verify="required|noticeDate" class="layui-input" value="${vo.noticeDate}">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
