...
public class NoticeServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("add".equals(action)) {//增加
            ...
            vo.setUseId(loginUser.getId());
            String noticeText = Util.decode(request, "noticeText");
            if (noticeText != null && !noticeText.equals("")) {
                vo.setNoticeText(noticeText);
            }
            String noticeDate = Util.decode(request, "noticeDate");
            if (noticeDate != null && !noticeDate.equals("")) {
    ...
    private void redirectList(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        NoticeService noticeService = new NoticeServiceImpl();
        response.getWriter().println(com.alibaba.fastjson.JSONObject.toJSONString(noticeService.list(params,userId).get("list")));
    }
}
